...
const PublicLanding: React.FC<PublicLandingProps> = ({ onLoginClick, onPelangganClick }) => {
    ...
    return (
      <div className="fixed inset-0 bg-[#050505] z-[100] flex flex-col items-center justify-center">
        <div className="relative mb-8">
           <div className="w-24 h-24 border border-white/10 rounded-full absolute animate-ping opacity-20"></div>
           <div className="w-24 h-24 border-t-2 border-brand-gold rounded-full animate-spin"></div>
           <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-brand-gold font-serif font-bold text-4xl">S</span>
           </div>
        </div>
        <div className="text-center space-y-3 animate-pulse">
           <h1 className="text-xl font-serif font-bold text-white tracking-[0.5em] pl-2">SUBARU</h1>
           <p className="text-[9px] text-gray-500 uppercase tracking-[0.3em]">Premium Beef Selection</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-gray-200 font-sans selection:bg-brand-gold selection:text-black overflow-x-hidden">
      
      {/* --- NAVIGATION (MINIMALIST) --- */}
      <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-[#050505]/80 backdrop-blur-md border-b border-white/5 py-3' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between">
            {/* Logo Area */}
            <div className="flex items-center gap-3 cursor-pointer group" onClick={(e) => scrollToSection(e, 'home')}>
              {appSettings.logoUrl ? (
                  <img src={appSettings.logoUrl} alt="Logo" className="w-10 h-10 object-contain rounded-lg bg-white/10 p-1" />
              ) : (
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] text-brand-gold font-bold leading-none mt-1 group-hover:text-white transition-colors">
                  Daging Sapi
                </span>
              </div>
            </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-12">
          <div className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand-gold/30 bg-brand-gold/5 backdrop-blur-sm animate-in fade-in slide-in-from-top-4 duration-700">
             <Star size={12} className="text-brand-gold fill-brand-gold" />
             <span className="text-[10px] uppercase tracking-[0.2em] text-brand-gold font-bold">The Premium Choice</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-gray-400 mb-12 max-w-2xl mx-auto font-light leading-relaxed tracking-wide animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
      ...
      <section className="py-24 bg-[#0a0a0a] relative overflow-hidden border-t border-white/5">
         <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
                <span className="text-brand-gold text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Program Spesial</span>
                <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-4">Program Loyalitas Pelanggan</h2>
                <p className="text-gray-400 max-w-2xl mx-auto">Dapatkan reward menarik dengan berlangganan produk daging sapi premium kami selama periode Maret - Agustus 2026.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                {/* Reward Tiers */}
                <div className="space-y-4">
                    <h3 className="text-2xl font-serif font-bold text-white mb-6">Skema Reward (6 Bulan)</h3>
                    {[
                        ...
                        <div key={idx} className="flex items-center justify-between p-4 bg-[#121212] border border-white/5 rounded-xl hover:border-brand-gold/30 transition-colors group">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-full bg-brand-gold/10 text-brand-gold flex items-center justify-center font-bold text-sm group-hover:bg-brand-gold group-hover:text-black transition-colors">
                                    {idx + 1}
                                </div>
                                <div>
                                    <p className="text-white font-bold">Target: {tier.target}</p>
                                    <p className="text-xs text-gray-500">Rata-rata: {tier.monthly}/bulan</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <p className="text-[10px] text-gray-500 uppercase tracking-wider">Reward</p>
                                <p className="text-brand-gold font-bold font-mono">{tier.reward}</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                {/* Terms & Conditions */}
                <div className="bg-[#121212] border border-white/5 rounded-2xl p-8 md:p-10 relative">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-brand-gold/5 blur-3xl rounded-full"></div>
                    <h3 className="text-xl font-serif font-bold text-white mb-6 flex items-center gap-2">
                        <BadgeCheck className="text-brand-gold" size={20} /> Syarat & Ketentuan
                    </h3>
                    <ul className="space-y-4 text-sm text-gray-400">
                        <li className="flex gap-3">
                            <div className="w-1.5 h-1.5 rounded-full bg-brand-gold mt-2 flex-shrink-0"></div>
                            <p>Program berlaku untuk <span className="text-white">semua jenis produk daging</span>.</p>
                        </li>
                        <li className="flex gap-3">
                            <div className="w-1.5 h-1.5 rounded-full bg-brand-gold mt-2 flex-shrink-0"></div>
                            <p>Periode kontrak berjalan selama 6 bulan: <span className="text-white">Maret 2026 - Agustus 2026</span>.</p>
                        </li>
                        <li className="flex gap-3">
                            <div className="w-1.5 h-1.5 rounded-full bg-brand-gold mt-2 flex-shrink-0"></div>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10">
                        <a href="https://wa.me/6281369612006" target="_blank" rel="noreferrer" className="w-full py-3 bg-white text-black font-bold rounded-lg text-xs tracking-widest uppercase hover:bg-brand-gold transition-colors flex items-center justify-center gap-2">
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
                <div className="md:w-1/3">
                    ...
                    <p className="text-gray-500 text-xs leading-relaxed mb-2 flex items-start gap-2">
                    ...
                    <p className="text-gray-500 text-xs leading-relaxed mb-6 flex items-center gap-2">
                ...
                <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
                    <div>
                        ...
                        <ul className="space-y-3 text-xs text-gray-500">
                            <li><a href="https://wa.me/6289649005383" target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors flex items-center gap-2"><MessageCircle size={14}/> Admin Retail (WA)</a></li>
                            <li><a href="https://wa.me/6281369612006" target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors flex items-center gap-2"><MessageCircle size={14}/> Admin Grosir (WA)</a></li>
                            <li><a href="https://wa.me/6289514077980" target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors flex items-center gap-2"><MessageCircle size={14}/> Sales Visit</a></li>
                            <li><a href="tel:+6285166599976" className="hover:text-brand-gold transition-colors flex items-center gap-2"><Phone size={14}/> Hotline Kantor</a></li>
                            <li><a href="mailto:ptsubarualammakmur@gmail.com" className="hover:text-brand-gold transition-colors flex items-center gap-2"><Mail size={14}/> ptsubarualammakmur@gmail.com</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-white font-bold text-sm mb-4">Link Terkait</h4>
                        <ul className="space-y-3 text-xs text-gray-500">
                            <li><a href="https://disnakkeswan.lampungprov.go.id/" target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors flex items-center gap-2"><Globe size={12}/> Dinas Peternakan Lampung</a></li>
                            <li><a href="https://disperindag.lampungprov.go.id/" target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors flex items-center gap-2"><Globe size={12}/> Dinas Perdagangan Lampung</a></li>
                            <li><a href="https://lampungprov.go.id/" target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors flex items-center gap-2"><Globe size={12}/> Pemprov Lampung</a></li>
                        </ul>
                    </div>
                    <div>
      ...
      {activeModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md p-4 md:p-6 animate-in fade-in duration-300">
            <div className="bg-[#121212] w-full max-w-sm rounded-2xl border border-white/10 p-6 md:p-8 relative shadow-2xl max-h-[90vh] overflow-y-auto">
                 <button onClick={handleCloseModal} className="absolute top-4 right-4 text-gray-500 hover:text-white transition-colors z-10"><XIcon size={20}/></button>
                 ...
                 {activeModal === 'loyalty' ? (
                       ...
                       <div className="text-left max-h-[80vh] overflow-y-auto pr-2">
                           ...
                           <button onClick={handleCloseModal} className="w-full py-3 mt-8 bg-white/5 border border-white/10 text-white font-bold rounded-lg text-xs tracking-widest hover:bg-white/10 transition-colors uppercase">Tutup</button>
                       </div>
                   ) : activeModal === 'success' ? (
                      <div className="text-center">
                         ...
                         <button onClick={handleCloseModal} className="w-full py-3 bg-white text-black font-bold rounded-lg text-xs tracking-widest hover:bg-gray-200 uppercase">Tutup</button>
                      </div>
                  ) : activeModal === 'checkin' ? (
                      <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-left max-h-[70vh] overflow-y-auto pr-2">
                          <h3 className="text-xl font-serif font-bold text-white mb-4">Privacy Policy</h3>
                          ...
                          <button onClick={handleCloseModal} className="w-full py-3 mt-6 bg-white text-black font-bold rounded-lg text-xs tracking-widest hover:bg-gray-200 uppercase">Tutup</button>
                      </div>
                  ) : activeModal === 'terms' ? (
                      <div className="text-left max-h-[70vh] overflow-y-auto pr-2">
                          <h3 className="text-xl font-serif font-bold text-white mb-4">Terms of Service</h3>
                          <div className="text-xs text-gray-400 space-y-3">
                      ...
                      <div className="text-center">
                          <h3 className="text-xl font-serif font-bold text-white mb-2">Karir</h3>
                          <p className="text-gray-400 text-xs mb-6">Bergabunglah dengan tim profesional kami.</p>
                          
                          <div className="bg-white/5 p-4 rounded-lg mb-4 text-left">
                              <h4 className="text-white font-bold text-sm">Posisi Tersedia:</h4>
                          ...
                          <p className="text-xs text-gray-500 mb-4">Kirim CV Anda ke email kami dengan subjek "Lamaran Kerja - [Posisi]".</p>
                          ...
                          <button onClick={handleCloseModal} className="block w-full py-3 bg-transparent border border-white/10 text-gray-400 rounded-lg font-bold text-xs hover:text-white hover:border-white/30 transition-colors">
                              Kembali
                          </button>
                      </div>
                  ) : (
                      <div className="text-center">
                         <h3 className="text-xl font-serif font-bold text-white mb-2">Hubungi Kami</h3>
                         <p className="text-gray-400 text-xs mb-6">Silakan hubungi admin via WhatsApp untuk respon cepat.</p>
                         
                         <a href="https://wa.me/6281234567890" target="_blank" rel="noreferrer" className="block w-full py-3 bg-[#25D366] text-white rounded-lg font-bold mb-3 flex items-center justify-center gap-2 hover:bg-[#20bd5a] transition-colors shadow-lg shadow-green-900/20">
